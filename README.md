...
We need a set of JDKs, Gradle, and Maven versions to run IRIS on CWE-Bench-Java, a benchmark we have curated of 120 vulnerabilities in real-world Java projects. These versions are indicated in .json files.
...
JDK 17 (*NOT* 17.0.12): https://www.oracle.com/java/technologies/javase/jdk17-archive-downloads.html
