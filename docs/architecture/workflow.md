...
IRIS accepts a project and a CWE (Common Weakness Enumeration) as input, and uses a neurosymbolic approach to identify security vulnerabilites of type CWE in the codebase. To achieve this, IRIS takes the following steps:
